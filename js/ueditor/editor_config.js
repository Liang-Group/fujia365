...
,toolbars:[["FullScreen","Source","Undo","Redo","Preview","|","Bold","Italic","Underline","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","PastePlain","FontSize","|","InsertTable","DeleteTable","MergeRight","MergeDown","SplittoRows","SplittoCols","SplittoCells","MergeCells","InsertCol","InsertRow","DeleteCol","DeleteRow","InsertParagraphBeforeTable"]]
//当鼠标放在工具栏上时显示的tooltip提示
,labelMap:{'fullscreen':'','source':'','undo':'','redo':'','preview':'','|':'','bold':'','italic':'','underline':'','justifyleft':'','justifycenter':'','justifyright':'','justifyjustify':'','pasteplain':'','fontsize':'','|':'','inserttable':'','deletetable':'','mergeright':'','mergedown':'','splittorows':'','splittocols':'','splittocells':'','mergecells':'','insertcol':'','insertrow':'','deletecol':'','deleterow':'','insertparagraphbeforetable':''}
