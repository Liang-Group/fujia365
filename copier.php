...
<div class="navbar">
  <div class="navbar-inner">
    ...
    <ul class="nav">
    	<li <?=(!isset($_GET['color']) || $_GET['color'] == "") ? "class='active'" : ""?>><a href="copier.php">所有</a></li>
    	<?php
    		$colors = $db->get_all("select distinct color from products where category = '复印机' order by color;");
    		...
    		foreach ($colors as $color) {
    			...
    			echo "<li  $active><a href='copier.php?color=$color[color]'>$color[color]</a></li>";
    		}
    	?>
    </ul>
  </div>
